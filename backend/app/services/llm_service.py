...
def _build_intent_prompt(user_text: str) -> str:
    return (
        ...
        "read_sensor -> {\"sensor\": \"temperature\"|\"humidity\"|\"all\"} (tuỳ chọn, mặc định all); "
        ...
        "Ví dụ:\n"
        "- Câu lệnh: 'nhiệt độ hiện tại là bao nhiêu' -> {\"intent\": \"read_sensor\", \"params\": {\"sensor\": \"temperature\"}, \"confidence\": 0.9}\n"
        "- Câu lệnh: 'trời nóng quá, nhiệt độ bao nhiêu vậy' -> {\"intent\": \"read_sensor\", \"params\": {\"sensor\": \"temperature\"}, \"confidence\": 0.9}\n"
        "- Câu lệnh: 'độ ẩm hiện tại bao nhiêu' -> {\"intent\": \"read_sensor\", \"params\": {\"sensor\": \"humidity\"}, \"confidence\": 0.9}\n"
        "- Câu lệnh: 'đọc nhiệt độ độ ẩm' -> {\"intent\": \"read_sensor\", \"params\": {\"sensor\": \"all\"}, \"confidence\": 0.9}\n"
